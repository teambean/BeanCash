...
void ThreadSocketHandler()
{
    ...
    while (true)
    {
        ...
        }
        {
            ...
            if (progress == 0) // Nothing happened even though select did not block, so slow down.
                MilliSleep(50);
    }
}
...
void ThreadDNSAddressSeed()
{
    ...
    if ((addrman.size() > 0) &&
        ...
        LOCK(cs_vNodes);
        if (vNodes.size() >= 2) {
            LogPrintf("P2P peers are available, so skipping DNS seeders.\n");
            return;
        }
    }
    ...
    unsigned int pnSeed[] =
    {
        0x8298a359, 0x9c98a359, 0x476c6805, 0x9398a359,
        0x5282a359, 0x4c6c6805, 0x4032b75f, 0x49ce724b,
        0x9f64f59d, 0x615056a7, 0x476c6805, 0x749dff33,
        0x394e3742, 0x6d0d5f46, 0xc0d1bc4b, 0x9120524c,
        0x04112351, 0x9c98a359, 0x0a99365e, 0xaa4ed95f,
        0x6e52cb74, 0x4551f388, 0xb43263a7, 0xd85fb7b8,
        0x3a884b8a, 0x13be96b9, 0xec0402bc, 0x146dc231,
        0x4d73c90e, 0xf5397dae, 0x1482c705, 0x0e47a868
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bean Cash is probably already running."), addrBind.ToString());
        else
