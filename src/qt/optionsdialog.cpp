...
// Copyright (c) 2022 Bean Core www.beancash.org
    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new BitbeanUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->minimizeBeanAge, OptionsModel::MinimizeBeanAge);
}
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Bean Cash."), QMessageBox::Ok);
