#ifndef BITBEANUNITS_H
#define BITBEANUNITS_H
...
public:
    ...
    //! Number of amount digits (to represent max number of beans)
...
typedef BitbeanUnits::Unit BitbeanUnit;

#endif // BITBEANUNITS_H
