...
{
    // beancash: check prefix
    if(!uri.isValid() || uri.scheme() != QString("beancash"))
        return false;
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Beancash.lnk";
}
...
{
    return GetAutostartDir() / "Beancash.desktop";
}
