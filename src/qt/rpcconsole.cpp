...
const int INITIAL_TRAFFIC_GRAPH_MINS = 6;
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if(model)
    {
        ...
        ui->isTestNet->setChecked(model->isTestNet());
    	  ...
    	  //Setup auto complete and attach it
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bean Cash RPC console.") + "<br>" +
...
{
    const int multiplier = 6; // each position on the slider represents 6 min
