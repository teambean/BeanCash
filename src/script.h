...
#ifndef H_BITBEAN_SCRIPT
#define H_BITBEAN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBitbeanAddress
 */
...
public:
    ...
    // Pre-version-0.6, Bitbean always counted CHECKMULTISIGs
