...
#ifndef BITBEAN_NET_H
#define BITBEAN_NET_H
...
inline unsigned int ReceiveFloodSize() { return 1000*GetArg("-maxreceivebuffer", 20*1000); }
...
public:
    ...
    uint256 hashCheckpointKnown; // ppbean: known sent sync-checkpoint
