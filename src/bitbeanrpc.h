...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Bitbean is not connected
...
/**
 * Bitbean RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value getsproutinginfo(const json_spirit::Array& params, bool fHelp);
